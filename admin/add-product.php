...
if(isset($_POST["submit"])){
  ...
  if($_FILES["image"]["error"] == 4){
    ...
    if ( !in_array($imageExtension, $validImageExtension) ){
      ...
      $query = "INSERT INTO product VALUES('','$category','$subcategory','$pname', '$newImageName','$price','')";
				...
				<div class="col-12">
					...
					<div class="card">
                        ...
                        <?php 
                            ...
                            $sql1 = "SELECT name,id from subcategory";
  ...
  <div class="col-12 col-md-6 col-lg-6">
    ...
    <form class="" action="" method="post" autocomplete="off" enctype="multipart/form-data">
                      ...
                      <div class="mb-3">
						  ...
						  <input type="text" name="pname" id = "pname" required value="" class="form-control" > 
                        </div>
                        <div class="mb-3">
                          <label>Product Price</label>
						  <input type="number" name="price" id = "price" required value="" class="form-control" > 
                        </div>
                      <div class="mb-3">
                        ...
                        <div class="mb-3">
                          <label>Select Sub Category Name</label>
                          <select  class="form-control" required name="subcategory"> 
                                <?php  $i=0; while($i<$num1) {$row1 = mysqli_fetch_assoc($result1); echo "<option value='".$row1['id']."'>".$row1['name']." </option>";  $i++;} ?>
                            </select>
                        </div>
                        <div class="mb-3">
